...
import LaunchPadSkeleton from "@/components/skeletons/launchpad";
                    ...
                    {launchInformation.openseaLink &&
                      launchInformation.openseaLink?.length > 0 && (
                        <div
                          ...
                          className="group flex w-fit cursor-pointer items-center gap-1 rounded-xl border-2 py-1 pl-2 pr-4 text-sm transition-transform hover:scale-105"
                        >
                          <Icon
