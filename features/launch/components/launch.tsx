        ...
        <section>
          <div className="container mx-auto mt-20 max-w-[1664px]  px-6 py-24 lg:grid lg:grid-cols-2">
            ...
            <article className="md:pr-12 lg:pr-32">
              ...
              <p className="my-4">
                This collection grants exclusive giveaways, accesses secret
                shows, and helps complete your Medallion of Memoria, the
                ultimate Tomorrowland experience.
              </p>
              <p>
                Read our&nbsp;
          ...
          <div className="container mx-auto grid max-w-[1664px] gap-10  px-6  py-24 md:grid-cols-2">
            <article className="mt-20 md:pr-12 lg:pr-32">
              ...
              <p className="my-5 text-gray-500">
                ...
                attendees, organized and still owned by two Belgian brothers.
                Now in its 16th year, Tomorrowland is one of the largest
                electronic music festivals in the world, with more than 400,000
                attendees to its annual summer festival, topping 600,000 in
                2022, and tickets always selling out in minutes. Tomorrowland
                has been voted the World&apos;s Best Music Event five times at
                the International Dance Music awards, and has been officially
                recognized by the UN as a symbol of global unity and community
                by Secretary General Ban Ki-Moon.
              </p>
              <p className="my-5 text-gray-500">
                The Tomorrowland Belgium 2022 collection, The Reflection of
                Love, offers holders unparalleled access to Tomorrowland for its
                biggest fans. Holders may participate in weekly exclusive
                giveaways of Tomorrowland fashion, events, experiences,
                backstage tours, and more, through holders-only community
                channels. These giveaways occur year-round. Holders attending
                Tomorrowland Belgium 2022 may also access an exclusive
                holder&apos;s only stage, with secret shows from massive
                artists.
              </p>
              <p className="my-5 text-gray-500">
                The Reflection of Love Collection is part of a series of three
                collections this year, along with a collection released at
                Tomorrowland Winter (A Letter from the Universe), and a
                collection dropping in the Fall. Own one NFT from each of these
                three collections to assemble the Medallion of Memoria; the
                ultimate Tomorrowland fan experience.
              </p>
              <p className="my-5 text-gray-500">
                ...
                the next Tomorrowland. A full breakdown of the NFT utility and
                art is available at <a href="https://minft.com"></a>
              </p>
              <p className="my-5 text-gray-500">
              ...
              <div className="mt-6">
                {activeTab === "roadmap" ? (
                  ...
                  <p>
                    ...
                    day in and day out. Everything related to this NFT is
                    created by the in-house creative, narrative, and tech teams,
                    with support from the entire company.
                  </p>
                )}
              </div>
            </article>
