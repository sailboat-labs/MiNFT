        ...
        <Transition appear show={showAuthDialog} as={Fragment}>
          ...
          >
            ...
            <div className="min-h-screen px-4 text-center">
              ...
              >
                <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle  shadow-xl transition-all dark:bg-[color:var(--dark)] dark:bg-gray-700 dark:text-white">
                  <Dialog.Title
                    as="h3"
