      ...
      <div className="container mx-auto max-w-2xl divide-y divide-gray-200 bg-gray-100 py-10">
        <div className="py-12">
          ...
          <div className="mt-8 flex gap-6">
            <BaseRadio className="flex-1">
              <div className="p-6">
                <strong>Canvas</strong>
                <p className="text-sm">
                  Much faster & requires less resources, but no animation
                  support
                </p>
              </div>
            </BaseRadio>
          ...
          <div className="py-10">
            <h4>Output</h4>
            <p>
              Dimensions and format used for exporting tokens. We highly
              recommend using source files with the same dimensions to reduce
              generation time.
            </p>
