...
export default function Header() {
  return (
    <div className="flex h-12 w-full flex-row items-center bg-indigo-800 font-montserrat font-bold text-white dark:text-gray-200">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
        ...
        className="ml-10 mr-3 sm:ml-20 lg:ml-40"
      >
        <path
