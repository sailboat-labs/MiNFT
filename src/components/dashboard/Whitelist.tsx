...
import WhitelistAccount from "./WhitelistAccount";
import ButtonLink from "../links/ButtonLink";

export default function Whitelist() {
  const [walletNumber, setWalletNumber] = useState("");

  const clearWalletNumber = (e) => {
    e.preventDefault();
    setWalletNumber("");
  };

  const updateWalletNumber = (e) => {
    e.preventDefault();
  ...
  const clearTwitterAccount = (e) => {
    e.preventDefault();
    setTwitterAccount("");
  };

  const updateTwitterAccount = (e) => {
    e.preventDefault();
    setTwitterAccount(e.target.value);
  };

  return (
    <div className="bg-white font-dmsans opacity-100">
            ...
            <div className="mt-3 flex h-12 w-3/5 flex-col justify-between">
              ...
              <div className="block font-montserrat">
                <button type="submit">
                  <ButtonLink
                    href="#"
                    className="mt-7 flex h-10 w-72 items-center justify-center rounded-lg border-0 bg-indigo-800 text-base font-bold text-white hover:bg-indigo-600"
                  >
                    Add person
                  </ButtonLink>
                </button>
      ...
      <div className="mt-28 border-t">
        <div className="pl-10 pt-5">
          ...
          <div className="mt-3 flex h-96 w-692 flex-col overflow-scroll rounded-lg border border-gray-300 p-1">
            <WhitelistAccount
              walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe"
            ...
            <WhitelistAccount
              ...
              twitterAccount="elonmusk"
            />
            <WhitelistAccount walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe" />
            <WhitelistAccount walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe" />
            <WhitelistAccount walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe" />
            <WhitelistAccount walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe" />
            <WhitelistAccount walletAddress="0x23432342ddvwr3erf4e2wreqw3245234sdf32saqwe" />
