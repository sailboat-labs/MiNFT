...
export default function Sidebar({ currentPage }: SidebarProps) {
  ...
  if (currentPage === "contract-maker") {
    contractMaker = true;
  } else if (currentPage === "nft-generator") {
    nftGenerator = true;
  } else if (currentPage === "project-builder") {
    projectBuilder = true;
  ...
  return (
    <div className="mt-12 w-96 bg-gray-100 px-5 font-dmsans opacity-100 ">
      <div className="m-auto flex w-80 flex-col pt-5">
        ...
        <div>
          <ButtonLink
            href="/dashboard/contract-maker"
            className={
              contractMaker
                ? `mt-12 ${selectedPageStyles}`
                : `mt-12 ${defaultStyles}`
            }
          >
            <svg
            ...
            <span className="w-52">Contract Maker</span>
            <svg
              className="h-6 w-6"
              width="24"
              height="24"
        ...
        <div>
          ...
          >
            ...
            <span className="w-52">NFT Generator</span>
            <svg
              className="h-6 w-6"
              width="24"
              height="24"
        ...
        <div>
          ...
          >
            ...
            <span className="w-52">Project Builder</span>
            <svg
              className="h-6 w-6"
              width="24"
              height="24"
        ...
        <div>
          <ButtonLink
            ...
            className={
              whiteList ? `mt-4 ${selectedPageStyles}` : `mt-4 ${defaultStyles}`
            }
          >
            <svg
              className="ml-2 mr-4 h-6 w-6"
            ...
            <span className="w-52">Whitelist</span>
            <svg
              className="h-6 w-6"
              width="24"
              height="24"
      ...
      <div>
        <div>
          ...
          >
            ...
            <span className="w-52">Support</span>
          </ButtonLink>
        </div>
