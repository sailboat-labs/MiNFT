...
export default function Guides() {
  return (
    <div className="relative">
      ...
      <div className="relative z-30 mx-auto w-10/12 border-b border-t border-black dark:border-gray-500">
        <div className="m-auto flex flex-col px-5 pt-20 pb-6 font-montserrat sm:w-4/5 lg:w-3/4">
          {guides.map((guide, index) => (
            <div
              key={index}
              className="z-30 mb-12 flex flex-row items-center justify-center rounded-2xl border border-black bg-transparent px-10 py-8 text-[#1F1A17] dark:border-gray-500 dark:bg-[rgba(255,255,255,0.02)] dark:backdrop-blur lg:h-96 lg:justify-between lg:px-16 lg:py-10  "
            >
              <div className="flex flex-col justify-center lg:w-[30rem]">
                <div className="text-2xl font-bold dark:text-white">
                  {guide.title}
                </div>
                <div className="relative z-30 mt-5 text-base font-normal dark:text-gray-300">
                  {guide.description}
                </div>
                <div
                  className={
