...
export default function Header() {
  return (
    <div className="fixed z-40 flex h-12 w-full flex-row items-center bg-white font-montserrat font-bold text-[#1F1A17]">
      <StarSVG className="ml-10 mr-3 h-6 w-6 sm:ml-20 lg:ml-40" />
      <UnstyledLink href="/" className="w-24 text-xl lg:mr-14">
        MiNFT
      </UnstyledLink>
      <span className="hidden sm:w-1/5 md:inline md:w-2/5"></span>
