  ...
  return (
    <div className="w-full">
      ...
      <div className="z-30 m-auto pt-10 pb-2 lg:w-4/5">
        <div className="z-30 m-auto mb-16 mt-5 flex w-4/5 flex-col justify-between font-montserrat lg:w-3/4 md:flex-row lg:items-center">
          ...
          <div className="flex flex-row justify-between sm:justify-start">
            <div
              className="z-30 flex h-14 w-32 cursor-pointer items-center justify-center rounded-xl border-0 bg-indigo-500 text-base font-bold text-white hover:bg-indigo-700 lg:w-56 sm:mr-10"
              onClick={() => {
